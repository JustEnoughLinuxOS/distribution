...
PKG_DEPENDS_TARGET="toolchain linux:host kmod:host cpio:host xz:host keyutils ncurses openssl:host rdfind:host wireless-regdb ${KERNEL_EXTRA_DEPENDS_TARGET}"
