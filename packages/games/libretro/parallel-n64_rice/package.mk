...
makeinstall_target() {
  ...
  if [[ "${ARCH}" == "aarch64" ]]
  then
    cp -vP ${DISTRO_DIR}/build.${DISTRO}-${DEVICE}.arm/parallel-n64_rice-*/.install_pkg/usr/lib/libretro/parallel_n64_rice_libretro.so ${INSTALL}/usr/lib/libretro/parallel_n64_rice_libretro.so
