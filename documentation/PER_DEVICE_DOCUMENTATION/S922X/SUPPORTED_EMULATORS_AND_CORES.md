...
|Nintendo|3DS (3ds)|2010|`3ds`|.3ds .3dsxX .elf .axf .cci .cxi .app|**citra:** citra-sa (default)<br>|
|Nintendo|DS (nds)|2005|`nds`|.nds .zip .7z|**drastic:** drastic-sa (default)<br>**retroarch:** melonds<br>|
